...
with picamera.PiCamera() as camera:
   ...
   # Attach overlays 
   topOverlay = camera.add_overlay(topOverlayImage.tobytes(), size=(704,60), layer=3, alpha=128, fullscreen=False, window=(0,20,704,60))
   bottomOverlay = camera.add_overlay(bottomOverlayImage.tobytes(), size=(704,60), layer=4, alpha=128, fullscreen=False, window=(0,500,704,60))
