...
textOverlayCanvas = Image.new("RGB", (704, 64))
...
with picamera.PiCamera() as camera:
   ...
   # Attach overlays
   topOverlay = camera.add_overlay(topOverlayImage.tobytes(), size=(704,64), layer=3, alpha=128, fullscreen=False, window=(0,20,704,64))
   bottomOverlay = camera.add_overlay(bottomOverlayImage.tobytes(), size=(704,64), layer=4, alpha=128, fullscreen=False, window=(0,500,704,64))
   crosshairOverlay = camera.add_overlay(crosshairPad.tobytes(), size=(704,512), layer=5, alpha=10, fullscreen=False, window=(20,30,704,512))
